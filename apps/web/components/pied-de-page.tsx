...
export function PiedDePage() {
  ...
  return (
    <footer className="px-4 pb-4 sm:px-5 sm:pb-5">
      ...
      <div className="mx-auto max-w-6xl rounded-[var(--rayon-jonction)] border border-border bg-card px-6 py-10 shadow-[0_18px_50px_-30px_rgba(0,0,0,0.35)] sm:px-10 sm:py-14 lg:px-14">
        ...
        >
          <KineticText
            as="span"
            text="Rémy"
            style={{ "--hover-padding": "calc(1em / 40)" } as React.CSSProperties}
        ...
        <div className="mt-12 grid grid-cols-2 gap-x-6 gap-y-10 sm:mt-14 sm:grid-cols-3 lg:grid-cols-[repeat(3,minmax(0,1fr))_minmax(0,1.3fr)] lg:gap-x-10">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <p className="text-sm font-semibold text-foreground">Le programme</p>
      ...
      {/* Sous la carte : le copyright et l'avertissement.
          ...
          déborder la page. */}
      <div className="mx-auto max-w-6xl px-6 pt-10 pb-10 sm:px-10 lg:px-14">
